...
?>
     ...
     <div id="main-form"> 
        ...
        <form id="first-form" method="post" autocomplete="on" action="" enctype="multipart/form-data">
            ...
            <label for="newName">所属・団体名</label>
            <input id="newName" type="text" name="belong" value="<?php echo h_esc(@$_SESSION['belong'][1]); ?>" />
            ...
            <input id="color" type="text" name="color" value="<?php echo h_esc(@$_SESSION['color'][1]); ?>" placeholder="#" />
            ...
            <textarea id="comment" rows="15" cols="80" name="comment"><?php echo h_esc(@$_SESSION['comment'][1]); ?></textarea><br />
            
            <label for="file">参考資料を添付</label>
            <input class="upFile" type="file" name="upFile[]" /><br />
            <input class="upFile" type="file" name="upFile[]" /><br />
            <input class="upFile" type="file" name="upFile[]" /><br />
            ...
            <input type="hidden" name="sz_ticket" id="sz_ticket" value="<?php echo h_esc($sz_ticket); ?>" />
            <input id="newSubmit" type="submit" name="submit" value="送信内容を確認" />
