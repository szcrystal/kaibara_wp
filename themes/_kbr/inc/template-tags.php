...
function _s_entry_footer() {
	...
	if ( ! is_single() && ! post_password_required() && isComment()/* && ( comments_open() || get_comments_number() )*/ ) {
		echo '<span class="comments-link">';
		comments_popup_link( esc_html__( 'コメントを残す', '_s' ), esc_html__( '1 コメント', '_s' ), esc_html__( '% コメント', '_s' ) );
		echo '</span>';
	}
